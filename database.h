...
public:
    ...
    static bool addImage(QString &filePath, int score, QString &comment, QString &color, QString &feeling, double xCrop, double yCrop, double widthCrop, double heightCrop);
    ...
    static bool updateImage(int idImage, QString &filePath, int score, QString &comment, QString &dominantColor, QString &feeling, double xCrop, double yCrop, double widthCrop, double heightCrop);
